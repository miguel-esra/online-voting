...
<div class="login-box bg-white box-shadow border-radius-10">
    <div class="login-title">
        <h2 class="text-center text-primary">Ingreso Administrador</h2>
    </div>
    ...
    <form action="<?= route_to('admin.login.handler') ?>" method="POST">
        ...
        <div class="input-group custom">
            <input type="text" class="form-control form-control-lg" placeholder="Usuario" name="login_id" value="<?= set_value('login_id') ?>">
        ...
        <div class="row pb-30" style="display: none;">
            ...
            <div class="col-8">
                <div class="forgot-password text-right">
                    <a href="<?= route_to('admin.forgot.form') ?>">¿Olvidaste la contraseña?</a>
                </div>
            </div>
        </div>
        <div class="row">
